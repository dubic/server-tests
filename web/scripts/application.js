...
//    var logged = false;
    ...
    var request = { url: "http://localhost:2020/server-test/push?id=dubic",
...
//    <!-- For demonstration of how you can customize the fallbackTransport using the onTransportFailure function -->
    request.onTransportFailure = function(errorMsg, request) {
        ...
        content.html($('<h3>', { text: 'Atmosphere Chat. Default transport is WebSocket, fallback is ' + request.fallbackTransport }));
    };

    request.onMessage = function (response) {
console.log("msg pushed is >>> "+response.responseBody);
content.html($('<p>', { text: response.responseBody }));
